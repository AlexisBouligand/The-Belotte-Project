...
#include "../include/graphicPasses.h"
#include "../include/button.h"
#include "../include/game.h"
#include "../include/graphicGame.h"
...
void initializePassWindow()
{
  //Window initisalization
    ...
    pass_screen = SDL_SetVideoMode(1600,900,32,SDL_HWSURFACE|SDL_DOUBLEBUF);//We set the window with video only, double buffering and full pass_screen
...
int graphicGetBet(int *max, Card_t *player_hand, Player_t *player_and_AI)
{
    ...
    TTF_Init();
    TTF_Font *font = NULL;
    font = TTF_OpenFont("asset/font/Minecraft.ttf", 60);
    checkFont(font);
    SDL_Color lightBrown = {99,92,92};

    //We create the background
    SDL_Surface *background = NULL;
    background = SDL_LoadBMP("asset/sprite/Background.bmp");
...
char graphicGetTrump()
{
    ...
    //We create the background
    SDL_Surface *background = NULL;
    background = SDL_LoadBMP("asset/sprite/Background.bmp");//! We need to free the surface at the end
    checkError(background);
...
void betButtonInitialization(Sprite_t bet_button[4])
{
    ...
    //File
    bet_button[0].bmp = SDL_LoadBMP("asset/sprite/button/left_arrow.bmp");
    bet_button[1].bmp = SDL_LoadBMP("asset/sprite/button/right_arrow.bmp");
    bet_button[2].bmp = SDL_LoadBMP("asset/sprite/button/pass_button.bmp");
    bet_button[3].bmp = SDL_LoadBMP("asset/sprite/button/continue_button.bmp");
...
{
    //file
    trump_button[0].bmp = SDL_LoadBMP("asset/sprite/button/trump_button1.bmp");
    trump_button[1].bmp = SDL_LoadBMP("asset/sprite/button/trump_button2.bmp");
    trump_button[2].bmp = SDL_LoadBMP("asset/sprite/button/trump_button3.bmp");
    trump_button[3].bmp = SDL_LoadBMP("asset/sprite/button/trump_button4.bmp");
    trump_button[4].bmp = SDL_LoadBMP("asset/sprite/button/trump_button5.bmp");
    trump_button[5].bmp = SDL_LoadBMP("asset/sprite/button/trump_button6.bmp");
